...
public class Valutatore {
    ...
    public static void main(String[] args) {
        Lexer lex = new Lexer();
        String path = "/Users/ilaario/Desktop/Progetti/2° Anno/Linguaggi Formali e Traduttori/ProgettoLFT/Es 4 - Validator/testValidator.txt"; // il percorso del file da leggere
        try {
